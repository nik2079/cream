...
_ready(function () {
    ...
    regLinkInModal.addEventListener("click",function(){
        ...
        let notActive = 'modalAuthReg-notActive';
        if (!this.classList.contains('active')){
            document.querySelector(".modalAuthReg-enter").classList.remove("modalAuthReg-active");
            document.querySelector(".modalAuthReg-enter").classList.add("modalAuthReg-notActive");
            this.classList.remove('modalAuthReg-notActive');
            this.classList.add('modalAuthReg-active');
        }
    },false);
});